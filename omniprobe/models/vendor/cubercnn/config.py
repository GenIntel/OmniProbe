...
# Modifications: removed DLA/ResNet/ViT-wrapper-specific backbone keys; the
# backbone is selected and configured through OmniProbe's Hydra configs.
...
def get_cfg_defaults(cfg):
    ...
    # render qualitative predictions (3D cuboids + BEV) during evaluation
    cfg.TEST.VISUALIZE_PREDICTIONS = False
