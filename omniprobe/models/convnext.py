...
class ConvNext(nn.Module):
    def __init__(
        ...
        self.output = output
        # ConvNeXt effective stride is 4/8/16/32 per stage. Using 16 for
        # center_padding so dense output aligns with stage-2/3 resolution.
        self.patch_size = 16
        ...
        # Extract per-stage feature dimensions from model structure
        feat_dims = [
