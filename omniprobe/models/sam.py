...
from .utils import default_multilayers, resolve_pretrained_path
...
class SAM(nn.Module):
    def __init__(self, arch, output="dense", layer=-1, return_multilayer=False):
        ...
        ckpt_path = resolve_pretrained_path("sam", ckpt_file, prefer_cache=True)
    ...
    def forward(self, x):
        ...
        return embeds[0] if len(self.multilayers) == 1 else embeds
