# Copied from facebookresearch/deit (Meta Platforms, Inc.) — Apache 2.0 License.
...
class Attention(nn.Module):
    # taken from github
    # @rwightman/pytorch-image-models/blob/master/timm/models/vision_transformer.py
    def __init__(
        self,
        dim,
        num_heads=8,
...
class Block(nn.Module):
    # taken from github.com/rwightman/pytorch-image-models/blob/master/
...
class Layer_scale_init_Block(nn.Module):
    # taken from https://github.com/rwightman/pytorch-image-models/blob/master/
    # timm/models/vision_transformer.py
